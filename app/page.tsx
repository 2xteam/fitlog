    ...
    <ThemeProvider>
      <div style={{ minHeight: "100vh", background: "var(--bg-primary)" }}>
        ...
        <main className="page">
          ...
          <Sheet point eyebrow="WHAT YOU GET" headline={<>숫자 하나가 아니라 <span className="mark">흐름을</span> 봅니다</>}>
          ...
          <Sheet center point eyebrow="START" headline="결과지 한 장만 찍어 볼까요?">
...
const FEATURES = [
  ...
  {
    "name": "항목별 추이",
    "desc": "날짜별로 쌓아 두니 지난달과 견줄 수 있습니다."
  }
];
